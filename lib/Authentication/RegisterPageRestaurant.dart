...
class RegisterPageR extends StatefulWidget {
  ...
  @override
  _RegisterPageRState createState() => _RegisterPageRState();
}
  ...
  void registerUser(BuildContext context) async{
    try {
      ...
      if(userCredential.user!.uid.toString().isNotEmpty){
        ...
        FirebaseFirestore.instance.collection("users").doc(user.uid).set(dataToSave).then((value) => Navigator.pushReplacementNamed(context, "/restaurant"));
                  ...
                  child: Container(
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            Image.asset("hamburger.png", fit: BoxFit.fill),
                            SizedBox(height: 4,),
                            Text(
                              "Register Yourself",
                              style: TextStyle(
